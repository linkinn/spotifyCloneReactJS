...
import { Creators as PlayActions } from '../../store/ducks/player';
      ...
      <Time>
        ...
        <ProgressSlider>
          <Slider
            ...
            max={1000}
            onChange={value => hanldePosition(value / 1000)}
...
Player.propTypes = {
  ...
  hanldePosition: PropTypes.func.isRequired,
...
const mapDispatchToProps = dispatch => bindActionCreators(PlayActions, dispatch);
